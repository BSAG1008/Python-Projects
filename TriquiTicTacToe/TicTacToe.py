...
HEIGHT=600
SIZE=(WIDTH,HEIGHT)
CIRCLER=pygame.image.load('circle.png')
CIRCLE=pygame.transform.scale(CIRCLER, (100,100))
CROSSR=pygame.image.load('x.png')
CROSS=pygame.transform.scale(CROSSR, (100,100))
...
pygame.display.set_caption("Steven - Tic Tac Toe")
window.fill(WHITE)
draw_lines()
pygame.display.update()
